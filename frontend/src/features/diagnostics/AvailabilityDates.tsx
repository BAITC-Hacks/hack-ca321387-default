import type { AvailabilityDay } from '../../shared/types/match'
import { formatDate, pluralVariants } from '../../shared/format'

export function AvailabilityDates({ days, selected, pending, onSelect }: { days: AvailabilityDay[]; selected: string; pending: boolean; onSelect: (date: string) => void }) {
