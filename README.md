...
Во frontend также доступны готовые сценарии поиска, подробный разбор ранжирования
и AI-чат. Правила подбора и API описаны в [архитектуре](docs/ARCHITECTURE.md).
